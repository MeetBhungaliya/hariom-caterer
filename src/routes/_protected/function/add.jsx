...
import { BadgeIndianRupee, Calendar, IndianRupee, MapPinHouse, NotebookPen, Plus, UserRound, UsersRound } from 'lucide-react';
          ...
          <div className='flex flex-col gap-y-4'>
            ...
            <ScrollArea className="h-[322px] pr-4">
              <div className='flex flex-col gap-y-2'>
                {data.map((_, index) => {
                  return (
                    <div key={index} className='py-1 grid grid-cols-5 gap-4'>
                      <Field
                      ...
                      <Field
                        ...
                        listeners={{
                          onChange: (e) => {
                            if (getFieldValue(`data[${index}].rate`) && ee.target.valueAsNumber) {
                      ...
                      <Field
                        ...
                        listeners={{
                          onChange: (e) => {
                            if (getFieldValue(`data[${index}].person`) && ee.target.valueAsNumber) {
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              if (e.target.valueAsNumber > MAX) {
                                ...
                                if (getFieldValue(`pro.rate`) && ee.target.valueAsNumber) {
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              if (e.target.valueAsNumber > MAX) {
                                ...
                                field.handleChange(e.target.valueAsNumber)
                                if (getFieldValue(`pro.count`) && e.target.valueAsNumber) {
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              if (e.target.valueAsNumber > MAX) {
                                ...
                                field.handleChange(e.target.valueAsNumber)
                                if (getFieldValue(`bottle.rate`) && ee.target.valueAsNumber) {
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              if (e.target.valueAsNumber > MAX) {
                                ...
                                field.handleChange(e.target.valueAsNumber)
                                if (getFieldValue(`bottle.count`) && e.target.valueAsNumber) {
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              if (e.target.valueAsNumber > MAX) {
                                ...
                                field.handleChange(e.target.valueAsNumber)
                                if (getFieldValue(`decoration.rate`) && ee.target.valueAsNumber) {
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              if (e.target.valueAsNumber > MAX) {
                                ...
                                field.handleChange(e.target.valueAsNumber)
                                if (getFieldValue(`decoration.count`) && e.target.valueAsNumber) {
